var place_types = [ "All categories", "accounting", "airport", "amusement_park", "aquarium", "art_gallery",
...
function addPlacesOptions() {
	var options = document.getElementById("place-types");
	var i;
	for (i = 0; i < place_types.length; i++) {
		var option = document.createElement("option");
		option.innerHTML = place_types[i];
		option.value = place_types[i];
